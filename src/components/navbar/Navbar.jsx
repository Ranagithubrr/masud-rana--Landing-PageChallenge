...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white flex justify-between items-center px-10 lg:px-14 py-4">
            ...
            <ul className={`py-6 md:py-0 m-0 text-center md:text-left block fixed md:flex justify-center space-x-4  top-0 ${mobileMenu ? 'left-0' : '-left-full'}  w-full bg-gray-200 md:bg-transparent md:static`}>
